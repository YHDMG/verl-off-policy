...
# This script is intended for a quick server-side smoke test of plain on-policy
# GRPO. Keep the layout simple so it is easy to tune directly on the server.


# ================================ Project configuration ================================
project_name='baseline-grpo'
exp_name='grpo-qwen3-1.7b-new-test'
